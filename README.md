...
**[Book Store]** is a SPA created to add and follow all yours readings.
...
sh
cd my-folder
git clone https://github.com/Dachrono/Bookstore.git
...
- [1] **[Create categories pages]**
- [2] **[Create coolest desing]**
...
Feel free to check the [issues page](https://github.com/Dachrono/Bookstore/issues).
